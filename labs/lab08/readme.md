# Lab 08: Prompt-to-Map: Using LLMs for Map Generation and Spatial Analysis
...
1. How did the way you wrote your prompt affect the accuracy, completeness, or usefulness of the code generated by the LLM?
2. How does using natural language to generate spatial analysis workflows change your understanding of what it means to "do GIS"?
3. In what ways might relying on LLMs for spatial tasks reinforce or obscure power dynamics in how maps are produced and interpreted?
...
>    `zhaobo@uw.edu`, `lp36@uw.edu`,and `alexak24@uw.edu`
